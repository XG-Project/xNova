...
if ($galaxy > MAX_GALAXY_IN_WORLD OR $galaxy < 1)
{
...
if ($system > MAX_SYSTEM_IN_GALAXY OR $system < 1)
{
...
if ($planet > MAX_PLANET_IN_SYSTEM OR $planet < 1)
{
...
$QrySelectEnemy .= "`planet` = '".intval($_POST['planet'])."' && ";
