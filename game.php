...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'changelog':
		include_once(XN_ROOT.'includes/pages/class.ShowChangelogPage.php');
		new ShowChangelogPage();
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'overview':
		include_once(XN_ROOT.'includes/pages/class.ShowOverviewPage.php');
		new ShowOverviewPage($user, $planetrow);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'galaxy':
		include_once(XN_ROOT.'includes/pages/class.ShowGalaxyPage.php');
		new ShowGalaxyPage($user, $planetrow);
	break;
	case'phalanx':
		include_once(XN_ROOT.'includes/pages/class.ShowPhalanxPage.php');
		new ShowPhalanxPage($user, $planetrow);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'imperium':
		include_once(XN_ROOT.'includes/pages/class.ShowImperiumPage.php');
		new ShowImperiumPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'fleet':
		include_once(XN_ROOT.'includes/pages/class.ShowFleetPage.php');
		new ShowFleetPage($user, $planetrow);
	break;
	case'fleet1':
		include_once(XN_ROOT.'includes/pages/class.ShowFleet1Page.php');
		new ShowFleet1Page($user, $planetrow);
	break;
	case'fleet2':
		include_once(XN_ROOT.'includes/pages/class.ShowFleet2Page.php');
		new ShowFleet2Page($user, $planetrow);
	break;
	case'fleet3':
		include_once(XN_ROOT.'includes/pages/class.ShowFleet3Page.php');
		new ShowFleet3Page($user, $planetrow);
	break;
	case'fleetACS':
		include_once(XN_ROOT.'includes/pages/class.ShowFleetACSPage.php');
		new ShowFleetACSPage($user, $planetrow);
	break;
	case'shortcuts':
		include_once(XN_ROOT.'includes/pages/class.ShowFleetShortcuts.php');
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'buildings':
		...
		{
			case 'research':
				include_once(XN_ROOT.'includes/pages/class.ShowResearchPage.php');
				new ShowResearchPage($planetrow, $user, $IsWorking['OnWork'], $IsWorking['WorkOn']);
			break;
			case 'fleet':
				include_once(XN_ROOT.'includes/pages/class.ShowShipyardPage.php');
			...
			break;
			default:
				include_once(XN_ROOT.'includes/pages/class.ShowBuildingsPage.php');
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'resources':
		include_once(XN_ROOT.'includes/pages/class.ShowResourcesPage.php');
...
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'trader':
		include_once(XN_ROOT.'includes/pages/class.ShowTraderPage.php');
		new ShowTraderPage($user, $planetrow);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'techtree':
		include_once(XN_ROOT.'includes/pages/class.ShowTechTreePage.php');
		new ShowTechTreePage($user, $planetrow);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'infos':
		include_once(XN_ROOT.'includes/pages/class.ShowInfosPage.php');
		new ShowInfosPage($user, $planetrow, $_GET['gid']);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'messages':
		include_once(XN_ROOT.'includes/pages/class.ShowMessagesPage.php');
		new ShowMessagesPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'alliance':
		include_once(XN_ROOT.'includes/pages/class.ShowAlliancePage.php');
		new ShowAlliancePage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'buddy':
		include_once(XN_ROOT.'includes/pages/class.ShowBuddyPage.php');
		new ShowBuddyPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'notes':
		include_once(XN_ROOT.'includes/pages/class.ShowNotesPage.php');
		new ShowNotesPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'statistics':
		include_once(XN_ROOT.'includes/pages/class.ShowStatisticsPage.php');
		new ShowStatisticsPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'search':
		include_once(XN_ROOT.'includes/pages/class.ShowSearchPage.php');
		new ShowSearchPage();
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'options':
		include_once(XN_ROOT.'includes/pages/class.ShowOptionsPage.php');
		new ShowOptionsPage($user);
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'banned':
		include_once(XN_ROOT.'includes/pages/class.ShowBannedPage.php');
		new ShowBannedPage();
	break;
// ----------------------------------------------------------------------------------------------------------------------------------------------//
	case'logout':
