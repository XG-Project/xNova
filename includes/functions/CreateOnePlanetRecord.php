...
function CreateOnePlanetRecord($Galaxy, $System, $Position, $PlanetOwnerID, $PlanetName = '', $HomeWorld = FALSE)
{
	...
	if ( ! $PlanetExist)
	{
		...
		// Posisción  1 -  3: 80% entre  40 y  70 Campos (55+  / -15)
		// Posisción  4 -  6: 80% entre 120 y 310 Campos (215+ / -95)
		// Posisción  7 -  9: 80% entre 105 y 195 Campos (150+ / -45)
		// Posisción 10 - 12: 80% entre  75 y 125 Campos (100+ / -25)
		// Posisción 13 - 15: 80% entre  60 y 190 Campos (125+ / -65)
		...
		$QrySelectPlanet .= "`planet` = '".$planet['planet']."' && ";
		...
		if ($GetGalaxyID)
		{
			...
			$QryUpdateGalaxy .= "`system` = '".$planet['system']."' && ";
