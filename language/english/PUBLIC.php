...
$lang['server_description']				= '</strong> is a <strong>strategic space simulation game</strong> with <strong>lots of players</strong> all over the world competing <strong>simultaneously</strong> to be the best. Everything you need to play is a web browser.';
...
$lang['welcome_message_content']		= 'Welcome to xNova!<p>At the beginning, build a metal mine.<br>To do this, click on the link "buildings" on the left, and click on "build" to the right of mine metal.<br>Now you have some time to learn more about the game.<p>Can find help:<br>In our <a href="http://www.razican.com/" target="_blank">Forums</a><br>Now your mine should be finished.<br>As produce nothing without energy, you should build a solar power plant, click on "buildings", and chose to build solar power plant.<p>To see all the ships, defense structures, buildings and research that can investigate, you can have a look at tree tech "Technology" in the left menu.<p>You can now begin the conquest of the universe... Good luck!';
