...
'2.10.3' => ' 06/07/2012
-[Mejoras]
- Mejorado el paquete de idioma en inglés, se tradujeron varios textos faltantes (By cyberghoser1).-
- Varias mejoras internas de código.-

-[Bugs]
#10056: Corregido un bug que mostraba la producción en rojo a pesar de tener capacidad para producir.-
#10050: Corregido un bug que permitía utilizar el mercader incluso cuando los almacenes estaban llenos (By zebulonbof).-
#10046: Corregido un bug que no permitía enviar expediciones.-
#10039: Corregido un bug que provocaba sobre carga (By jstar).-
#10035: Corregido un bug que permitía actualizar el juego bajo cualquier circunstancia (By Razican).-
#10034: Corregido un bug en el que no se podía leer la licencia (By Razican).-
#10033: Corregido un bug que no guardaba el id del usuario al registrar un cambio en la página de configuraciones (By Razican).-
#10032: Corregido un bug que no informaba cuando había una nueva versión disponible (By Razican).-
#10031: Corregido un bug en la importación (By Razican).-
...
-[Mejoras]
- Mejorado el paquete de idioma en inglés, se tradujeron varios textos faltantes (By cyberghoser1).-
- Mejorado el sistema para determinar si un jugador es fuerte o débil.-
- Mejorado el sistema de producción.-
...
-[Bugs]
#9854: Corregido un bug que no permitía enviar sondas desde galaxia.-
#0000: Corregido un bug en el que el sistema de jugadores débiles no funcionaba correctamente al enviar flotas desde galaxia.-
#0000: Corregido un bug que mostraba mal el texto de error de enviar una sonda desde galaxia.-
#0000: Corregido un bug que al cliquear en el nombre de un oficial de redirigía a una página vacía.-

- [Cambios]
- Eliminada plantilla "/infos/info_officiers_general.php".-
- Opción de overflow de los almacenes removida.-
- Modificado el link en el admin cp que redirigía al tracker.-
...
'2.10.1' => ' 06/04/2012
-[Mejoras]
- Mejora menor en el informe de actualización que te informa de que versión a cual otra pasaste.-

-[Bugs]

#9943: Corregido el bug de los permisos de la alianza.-
#9934: Ahora es posible enviar naves con la misión de mantener posición a una Luna.-
...
#9857: Error que producía problemas en las estadísticas y en varias otras páginas del juego (By Jstar).-
#9852: Calculo erroneo en los días de inactividad de un usuario en el panel administrativo.-
#9850: No se pueden enviar sondas a atacar, producen un error.-
#9837: Límite en la cantidad de naves que se pueden enviar durante el salto cuántico (By Gmir17).-
...
#0000: Correcciones a caracteres erróneos en algunos textos.-
#0000: Corregido un bug que impedía enviar una flota a mantener posición si no tenía deposito de la alianza.-
#0000: Corregido un bug que no informaba correctamente si había una nueva versión disponible.-
#0000: Corregido un bug que mostraba únicamente la primer flota en el phalanx (By jstar).-
',
...
--- Las plantillas .tpl ahora requieren extensión .php, esto es para mayor protección y para que sea más simple trabajarlo.-
--- Creadas las plantillas correspondientes para la página de amigos/compañeros.-
--- Creadas las plantillas correspondientes para la página de mensajes.-
--- Creadas las plantillas faltantes para la página de la galaxia.-
--- Pulida la página de baneos y agregada la plantilla faltante.-
--- Mejorada la muestra de errores al enviar un mensaje.-
--- Creadas las plantillas faltantes para la página class.ShowFleetPage.php.-
--- Creadas las plantillas faltantes para la página class.ShowFleetPage1.php.-
--- Creadas las plantillas faltantes para la página class.ShowFleetPage2.php.-
--- Creadas las plantillas faltantes para la página class.ShowFleetPage3.php.-
--- Creadas las plantillas faltantes para la página class.ShowFleetACSPage.php.-
--- Creadas las plantillas faltantes para la página class.ShowAlliancePage.php.-
--- La plantilla fleetACS_table.php fue reorganizada. La misma contiene únicamente la tabla de agregar miembros y cambiar nombre; para el resto se reutiliza la plantilla fleet_table.php.-
--- Directorio templates renombrado a views.-

-- IDIOMA
--- Los archivos de lenguaje ahora requieren extensión .php, esto es para mayor protección y para que sea más simple trabajarlo.-
--- La página de mensajes privados ahora podrá estar en varios idiomas.-
--- Se completo las descripciones cortas del idioma español para los edificios lunares y terraformer.-
--- Correción menor de idioma en la página de SACs.-
--- No se le da más soporte al paquete de idioma francés, sólo español e inglés.-

-- CORE
--- Codificación de caracteres cambiada de iso-8859-1 a UTF-8.-
--- Copyrights actualizados, reducido el peso de los archivos en un 45%.-
--- Eliminados los $phpEx.-
--- Código pulido y estandarizado bajo un mismo formato.-
...
--- Eliminada la variable global $game_config, fue reemplazada por la función read_config().-
--- Nueva función read_config (lee la configuración requerida y retorna su valor).-
--- Archivos js comprimidos, la carga por el lado del cliente será mucho más rápida.-
--- Páginas seteadas dentro de una clase.-
--- El js overlib ya no se carga más en el login.-
--- Optimización de querys en la página de investigación (sobrecarga de querys cuando estaba desarrollada la red de invetigación).-
...
--- Removida la variable de configuración BuildLabWhileRun, no era utilizada.-

-- ALLIANCE
--- Se quito el bbCode de class.ShowAlliancePage.php y se movió a class.BBCode.php.-
--- El método MessageForm fue renombrado a message_box.-
--- Nuevo método return_rank, retorna el rango del usuario.-
--- Nuevo método return_sort, retorna el orden seleccionado por el usuario.-
--- Mejorado el borrado de la alianza, antes realizaba 1 query por cada usuario a borrar, ahora realiza únicamente una.-

-- FLEET
--- Tiempo de expedición reducido de 10 a 5 horas.-
--- Tiempo de mantener posición establecido por defecto en 1 y no en 0.-
--- Optimizaciones en class.ShowFleet1Page.php.-
--- Optimizaciones en class.ShowFleetACSPage.php.-
--- Nuevo selector de atajos / shortcuts en la página 1 del envío de flotas (class.ShowFleet1Page.php).-
--- Emprolijado el código y mejoras en la página 1 del envío de flotas (class.ShowFleet1Page.php).-
--- Emprolijado el código y mejoras en la página 2 del envío de flotas (class.ShowFleet2Page.php).-
--- Emprolijado el código y mejoras en la página 3 del envío de flotas (class.ShowFleet3Page.php).-
--- Emprolijado el código y mejoras en la página SAC del envío de flotas (class.ShowFleetACSPage.php).-
--- Corregido un bug menor que no mostraba el nombre del SAC en el título de la página de SACs (antes mostraba un código extraño).-

-- MENSAJES
--- Página de mensajes revisada y emprolijada.-
--- Mejorada la velocidad de carga en la página de mensajes.-
...
--- Los costes también fueron copiados (Editable desde vars).-
...
--- Requiere email y clave del administrador para validar la actualización.-
--- El sistema de encarga automáticamente de determinar los datos del servidor.-
--- El usuario ya no debe seleccionar más la versión que tiene, se determina automáticamente.-
--- El sistema de actualización no funciona con versiones no compatibles ni con versiones no oficiales, ya que es automático.-
...
--- Página de amigos/compañeros reprogramada.-
--- Mejoras menores en la página de la galaxia.-
--- class.ShowFleetPage.php optimizado de 2 consultas a 1.-
--- Reducción de querys global en el panel administrativo al cargar y realizar acciones.-

-[Fixs]
#----: Corregido un bug que no mostraría correctamente un skin seleccionado por un usuario.-
...
Optimizada importantemente la 2&ordf; página de lanzamiento de flota (by jtsamper/Think)
...
- [Seguridad] Protección con .htaccess de global.php, config.php y extension.inc.php.-
...
- Panel del admin, "Utilisateur?" -> "&iquest;Usuario?", modificación en el lenguaje.-
