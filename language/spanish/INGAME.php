...
// GAME.PHP
$lang['see_you_soon']						= '&iexcl;Hasta la pr&oacute;xima!';
$lang['page_doesnt_exist']					= 'La p&aacute;gina solicitada no existe';
...
$lang['tn_delete_mode']						= 'Tu cuenta se encuentra en modo borrar. La misma ser&aacute; borrada el ';

//----------------------------------------------------------------------------//
//LEFT MENU
$lang['lm_overview']						= 'Visi&oacute;n general';
$lang['lm_galaxy']							= 'Galaxia';
$lang['lm_empire']							= 'Imperio';
$lang['lm_fleet']							= 'Flota';
$lang['lm_buildings']						= 'Edificios';
$lang['lm_research']						= 'Investigaci&oacute;n';
...
$lang['lm_technology']						= 'Tecnolog&iacute;a';
$lang['lm_messages']						= 'Mensajes';
$lang['lm_alliance']						= 'Alianzas';
$lang['lm_buddylist']						= 'Lista de compa&ntilde;eros';
$lang['lm_notes']							= 'Notas';
$lang['lm_statistics']						= 'Estad&iacute;sticas';
...
$lang['lm_administration']					= 'Administraci&oacute;n';
...
//----------------------------------------------------------------------------//
//OVERVIEW
$lang['ov_newname_error']					= 'Has introducido alg&uacute;n caracter ilegal. S&oacute;lo puedes introducir caracteres alfanum&eacute;ricos.';
$lang['ov_planet_abandoned']				= 'Planeta abandonado con &eacute;xito.';
$lang['ov_principal_planet_cant_abanone']	= 'El planeta principal no puede ser abandonado.';
$lang['ov_wrong_pass']						= 'Contrase&ntilde;a incorrecta, vuelve a ingresarla.';
...
$lang['ov_diameter']						= 'Di&aacute;metro';
$lang['ov_distance_unit']					= 'km';
$lang['ov_temperature']						= 'Temperatura';
$lang['ov_aprox']							= 'aprox.';
$lang['ov_temp_unit']						= '&ordm;C';
$lang['ov_to']								= 'hasta';
$lang['ov_position']						= 'Posici&oacute;n';
$lang['ov_points']							= 'Puntos';
$lang['ov_security_request']				= 'Petici&oacute;n de seguridad';
$lang['ov_security_confirm']				= 'Confirmar borrado de planeta';
$lang['ov_with_pass']						= 'con contrase&ntilde;a';
$lang['ov_password']						= 'Contrase&ntilde;a';
$lang['ov_delete_planet']					= '&iexcl;Borrar planeta!';
...
//----------------------------------------------------------------------------//
//GALAXY
$lang['gl_no_deuterium_to_view_galaxy']		= '&iexcl;No hay suficiente deuterio!';
$lang['gl_legend']							= 'Leyenda';
$lang['gl_strong_player']					= 'Jugador fuerte';
$lang['gl_week_player']						= 'Jugador d&eacute;bil';
$lang['gl_vacation']						= 'Modo vacaciones';
$lang['gl_banned']							= 'Usuario suspendido';
$lang['gl_inactive_seven']					= 'Inactivo 7 d&iacute;as';
$lang['gl_inactive_twentyeight']			= 'Inactivo 28 d&iacute;as';
$lang['gl_s']								= 'f';
$lang['gl_w']								= 'd';
$lang['gl_v']								= 'v';
$lang['gl_b']								= 's';
...
$lang['gl_missil_to_launch']				= 'N&uacute;mero de misiles (<b>%d</b> restantes):';
...
$lang['gl_spy']								= 'Espiar';
$lang['gl_buddy_request']					= 'Solicitud de compa&ntilde;eros';
$lang['gl_missile_attack']					= 'Ataque con misiles';
$lang['gl_with']							= ' con ';
$lang['gl_member']							= ' miembro';
$lang['gl_member_add']						= 's';
$lang['gl_alliance_page']					= 'Ver p&aacute;gina de la alianza';
$lang['gl_see_on_stats']					= 'Ver en estad&iacute;sticas';
$lang['gl_alliance_web_page']				= 'P&aacute;gina principal de la alianza';
$lang['gl_debris_field']					= 'Campo de escombros';
$lang['gl_collect']							= 'Recolectar';
$lang['gl_resources']						= 'Recursos';
$lang['gl_features']						= 'Caracter&iacute;sticas';
$lang['gl_diameter']						= 'Di&aacute;metro';
...
$lang['gl_stat']							= 'Estad&iacute;sticas';

//----------------------------------------------------------------------------//
//PHALANX
$lang['px_no_deuterium']					= '&iexcl;No tienes deuterio!';
$lang['px_scan_position']					= 'Escanear posici&oacute;n';
$lang['px_fleet_movement']					= 'Movimiento actual de flotas';

//----------------------------------------------------------------------------//
//IMPERIUM
$lang['iv_imperium_title']					= 'Visi&oacute;n del Imperio';
...
$lang['iv_technology']						= 'Tecnolog&iacute;as';
$lang['iv_ships']							= 'Naves';
...
$lang['fl_anonymous']						= 'An&oacute;nimo';
...
$lang['fl_shortcut_edition']				= 'Edici&oacute;n: ';
...
$lang['fl_expedition_alert_message']		= 'Atenci&oacute;n ! Las expediciones son misiones arriesgadas, puedes perder tus naves !';
$lang['fl_vacation_mode_active']			= 'El modo vacaciones se encuentra activo';
$lang['fl_expedition_tech_required']		= '&iexcl;Investiga la Tecnologia de Expedicion!';
$lang['fl_expedition_fleets_limit']			= '&iexcl;Limite de flotas de Expedicion!';
$lang['fl_week_player']						= '&iexcl;El jugador es muy d&eacute;bil!';
$lang['fl_strong_player']					= '&iexcl;El jugador es muy fuerte!';
$lang['fl_in_vacation_player']				= '&iexcl;El jugador esta en modo vacaciones!';
$lang['fl_no_slots']						= 'No hay m&aacute;s slots disponibles';
$lang['fl_empty_transport']					= 'No puedes transportar 0 recursos';
$lang['fl_planet_populed']					= '&iexcl;Este planeta esta ocupado!';
$lang['fl_stay_not_on_enemy']				= '&iexcl;No puedes estacionar flotas en el enemigo!';
$lang['fl_not_ally_deposit']				= '&iexcl;No hay deposito de la alianza!';
$lang['fl_deploy_only_your_planets']		= '&iexcl;S&oacute;lo puedes desplegar flotas en tus planetas!';
...
$lang['fl_acs_invitation_title']			= 'Invitaci&oacute;n a SAC';
$lang['fl_sac_of_fleet']					= 'SAC de la flota';
$lang['fl_modify_sac_name']					= 'Modificar el nombre del SAC';
$lang['fl_members_invited']					= 'Participantes invitados';
$lang['fl_invite_members']					= 'Invitar participantes';
...
$lang['bd_lab_required']					= '&iexcl;Es necesario construir primero un laboratorio de investigaci&oacute;n en este planeta!';
...
$lang['bd_shipyard_required']				= '&iexcl;Debes construir un hangar en este planeta para continuar!';
$lang['bd_building_shipyard']				= 'No puedes fabricar durante la ampliaci&oacute;n del hangar, f&aacute;brica de robots o nanobots';
$lang['bd_available']						= 'Disponible: ';
$lang['bd_build_ships']						= 'Construir';
$lang['bd_protection_shield_only_one']		= '&iexcl;El escudo de protecci&oacute;n s&oacute;lo se puede construir una vez!';
$lang['bd_build_defenses']					= 'Construir';
$lang['bd_actual_production']				= 'Producci&oacute;n actual:';
...
$lang['rs_lvl']								= 'nivel';
$lang['rs_production_on_planet']			= 'Producci&oacute;n de recursos en el planeta "%s"';
$lang['rs_basic_income']					= 'Ingresos b&aacute;sicos';
...
//----------------------------------------------------------------------------//
//TRADER
$lang['tr_only_positive_numbers']			= '&iexcl;Solo se pueden usar n&uacute;meros positivos!';
...
$lang['tr_exchange_done']					= 'Intercambio realizado con &eacute;xito';
...
502 => "Misiles antibal&iacute;sticos",
...
33 => "El Terraformer es necesario para habilitar &aacute;reas inaccesibles de tu planeta para edificar infraestructuras.",
...
43 => "El saltos cu&aacute;nticos son transmisores enormes que son capaces de enviar grandes flotas a trav&eacute;s del universo sin perdida de tiempo.",
...
502 => "Los misiles antibal&iacute;sticos destruyen los misiles interplanetarios.",
503 => "Los misiles interplanetarios destruyen los sistemas de defensa del enemigo.",
601 => 'El ge&oacute;logo es un experto en astrominerolog&iacute;a y astrocristalograf&iacute;a. Apoyado por su equipo de metal&uacute;rgicos e ingenieros en qu&iacute;mica apoya a gobiernos interplanetarias a la explotaci&oacute;n de fuentes de recursos y a la optimazaci&oacute;n del refinamiento de estos recursos.<br><br><strong><font color="lime">+10% producci&oacute;n de minas</font></strong>',
602 => 'El almirante de flota es un veterano de guerra experimentado y un habilidoso estratega. En las batallas m&aacute;s duras, es capaz de hacerse una idea de la situaci&oacute;n y contactar a sus almirantes subordinados. Un emperador sabio puede confiar en su ayuda durante los combates y guiar m&aacute;s flotas al mismo tiempo.<br><br><strong><font color="lime">+2 huecos de flota m&aacute;ximos</font></strong>',
603 => 'El Ingeniero es un especialista en gesti&oacute;n de energ&iacute;a. En tiempos de paz aumenta la energ&iacute;a de todas las colonias. En caso de ataque, garantiza el abastecimiento de energ&iacute;a a los ca&ntilde;ones, evitando una posible sobrecarga, lo que conduce a una reducci&oacute;n de defensas perdidas en batalla.<br><br><strong><font color="lime">Minimiza las perdidas de las defensas a la mitad,<br />+10% de producci&oacute;n de energ&iacute;a</font></strong>',
604 => 'El gremio de los Tecn&oacute;cratas est&aacute; compuesto de aut&eacute;nticos genios y siempre los encontrar&aacute;s en un mundo donde la l&oacute;gica humana ser&iacute;a descartada. Desde hace miles de a&ntilde;os, ning&uacute;n ser humano normal ha podido descifrar el c&oacute;digo de un tecn&oacute;crata. El tecn&oacute;crata inspira a los investigadores del imperio con tan s&oacute;lo su presencia.<br><br><strong><font color="lime">+2 al nivel de espionaje,<br />-25% menos tiempo de investigaci&oacute;n</font></strong>',
);

//----------------------------------------------------------------------------//
//INFOS
$lang['in_jump_gate_done']					= 'El salto cu&aacute;ntico fue realizado, el pr&oacute;ximo salto podr&aacute; ser realizado en: ';
$lang['in_jump_gate_error_data']			= '&iexcl;Error, los datos para el salto son incorrectos!';
$lang['in_jump_gate_not_ready_target']		= 'El salto cu&aacute;ntico no est&aacute; listo en la Luna de destino, estar&aacute; listo en: ';
$lang['in_jump_gate_doesnt_have_one']		= '&iexcl;No tienes Salto cu&aacute;ntico en esa luna!';
$lang['in_jump_gate_already_used']			= 'El Salto cu&aacute;ntico fue usado, tiempo para recargar su energia: ';
...
$lang['in_used_energy'] 					= 'Consumo de energ&iacute;a';
$lang['in_prod_energy'] 					= 'Produci&oacute;n de energ&iacute;a';
$lang['in_used_deuter']						= 'Consumo de deuterio';
$lang['in_range']       					= 'Rango de sensores';
$lang['in_title_head']  					= 'Informaci&oacute;n de';
$lang['in_name']        					= 'Nombre';
...
$lang['in_jump_gate_select_ships']			= 'Usar Salto Cu&aacute;ntico: n&uacute;mero de naves';
$lang['in_jump_gate_jump']					= 'Saltar';
$lang['in_destroy']     					= 'Destruir:';
$lang['in_needed']      					= 'Necesita';
$lang['in_dest_durati'] 					= 'Duraci&oacute;n de destrucci&oacute;n';
...
<br><br>
Mayores complejos de reactores usan m&aacute;s deuterio y pueden producir m&aacute;s energ&iacute;a por hora. El efecto de energ&iacute;a puede ser aumentado investigando la tecnolog&iacute;a de energ&iacute;a.
<br><br>

La producci&oacute;n de energ&iacute;a de las plantas de fusi&oacute;n se calcula de la siguiente forma:<br><br>
30 * [Nivel de la Planta de Fusi&oacute;n] * (1,05 + [Nivel de la Tecnolog&iacute;a de Energ&iacute;a] * 0,01) ^ [Nivel de la Planta de Fusi&oacute;n]";
...
$lang['info'][22]['description']  			= "Bodegas enormes para almacenar metal sin procesar. Mientras m&aacute;s grande sea el almac&eacute;n, m&aacute;s aumentar&aacute; la capacidad de almacenaje del planeta. La recolecci&oacute;n de metal se detendr&aacute; cuando el almac&eacute;n est&eacute; lleno.";
$lang['info'][23]['name']         			= "Almac&eacute;n de cristal";
$lang['info'][23]['description']  			= "Bodegas enormes para almacenar cristal sin procesar. Mientras m&aacute;s grande sea el almac&eacute;n, m&aacute;s aumentar&aacute; la capacidad de almacenaje. La recolecci&oacute;n de cristal se detendr&aacute; cuando el almac&eacute;n est&eacute; lleno.";
$lang['info'][24]['name']         			= "Contenedor de deuterio";
$lang['info'][24]['description']  			= "Contenedores enormes para almacenar deuterio. Los contenedores se encuentran a menudo cerca del hangar. Los contenedores grandes son capaces de almacenar m&aacute;s deuterio. La recolecci&oacute;n de deuterio se detendr&aacute; cuando el contenedor est&eacute; lleno.";
...
Un peque&ntilde;o grupo de f&iacute;sicos de alta energ&iacute;a y nanot&eacute;cnicos finalmente encontraron una soluci&oacute;n: el Terraforming.<br>
...
$lang['info'][502]['name']        			= "Misiles antibal&iacute;sticos";
$lang['info'][502]['description'] 			= "Un misil antibal&iacute;stico puede proteger a tu planeta de un mis&iacute;l interplanetario que se est&aacute; aproximando.";
...
$lang['mg_type'][4]    						= 'Informes de recolecci&oacute;n';
$lang['mg_type'][5]    						= 'Informes de tranporte';
$lang['mg_type'][15]   						= 'Informes de expedici&oacute;n';
$lang['mg_type'][99]   						= 'Informes de construcci&oacute;n';
...
$lang['al_alliance_closed']					= 'Esta alianza no admite m&aacute;s miembros';
...
$lang['al_default_request_text']			= 'Los l&iacute;deres de la alianza no han creado un ejemplo de solicitud, o no tienen pretenciones.';
...
$lang['al_leave_sucess']					= 'Abandonaste la alianza %s con &eacute;xito.';
$lang['al_do_you_really_want_to_go_out']	= '&iquest;Realmente deseas salir de la alianza %s?';
...
$lang['al_hi_the_alliance']					= '&iexcl;Hola!<br>La alianza <b>';
...
$lang['al_position']						= 'Posici&oacute;n';
...
$lang['al_ally_information']				= 'Informaci&oacute;n de la alianza';
...
$lang['al_inside_section']					= 'Secci&oacute;n interna';
$lang['al_make_alliance']					= 'Fundar alianza';
$lang['al_make_ally_tag_required']			= 'Etiqueta de la alianza (De 3-8 caracteres)';
$lang['al_make_ally_name_required']			= 'Nombre de la alianza (M&aacute;x. 35 caracteres)';
...
$lang['al_manage_image']					= 'Im&aacute;gen de la alianza';
...
//----------------------------------------------------------------------------//
//BUDDY
$lang['bu_request_exists']					= '&iexcl;Ya existe una solicitud a ese jugador!';
$lang['bu_cannot_request_yourself']			= '&iexcl;No puedes solicitarte como compa&ntilde;ero a ti mismo!';
...
$lang['nt_size_note']						= 'Tama&ntilde;o';
...
$lang['st_researh']							= 'Investigaci&oacute;n';
$lang['st_buildings']						= 'Edificios';
$lang['st_defenses']						= 'Defensas';
$lang['st_position']						= 'Posici&oacute;n';
$lang['st_members']							= 'Miembros';
$lang['st_per_member']						= 'Por Miembro';
$lang['st_statistics']						= 'Estad&iacute;sticas';
...
$lang['sh_buddy_request']					= 'Solicitud de compa&ntilde;eros';
$lang['sh_alliance']						= 'Alianza';
$lang['sh_planet']							= 'Planeta';
$lang['sh_coords']							= 'Coordenadas';
$lang['sh_position']						= 'Posici&oacute;n';

//----------------------------------------------------------------------------//
//OPTIONS
$lang['op_cant_activate_vacation_mode']		= 'Si est&aacute;s construyendo o moviendo flotas no podr&aacute;s entrar al modo vaciones.';
$lang['op_password_changed']				= 'La contrase&ntilde;a ha sido cambiada.<br /><a href="index.php" target="_top">Volver</a>';
...
$lang['op_vacation_mode_active_message']	= 'El modo vacaciones se ha encendido. Tendra que estar de vacaciones como m&iacute;nimo hasta el: ';
$lang['op_end_vacation_mode']				= 'Finalizar modo vacaciones';
$lang['op_save_changes']					= 'Guardar cambios';
$lang['op_admin_title_options']				= 'Opciones reservadas para la administraci&oacute;n';
$lang['op_admin_planets_protection']		= 'Protecci&oacute;n de planetas';
$lang['op_user_data']						= 'Datos de usuario';
$lang['op_username']						= 'Nombre de usuario';
$lang['op_old_pass']						= 'Contrase&ntilde;a anterior';
$lang['op_new_pass']						= 'Nueva contrase&ntilde;a (min. 8 Caracteres)';
$lang['op_repeat_new_pass']					= 'Nueva contrase&ntilde;a (repetir)';
$lang['op_email_adress']					= 'Direcci&oacute;n de correo electr&oacute;nico';
$lang['op_permanent_email_adress']			= 'Direcci&oacute;n pemanente de correo electr&oacute;nico';
$lang['op_general_settings']				= 'Ajustes generales';
$lang['op_sort_planets_by']					= 'Ordenar planetas por:';
$lang['op_sort_kind']						= 'Tipo de ordenaci&oacute;n:';
$lang['op_skin_example']					= 'Skin';
$lang['op_show_skin']						= 'Mostrar skin';
$lang['op_deactivate_ipcheck']				= 'Desactivar comprobaci&oacute;n de IP';
$lang['op_galaxy_settings']					= 'Opciones de visi&oacute;n de Galaxia';
$lang['op_spy_probes_number']				= 'Cantidad de sondas de espionaje';
$lang['op_toolt_data']						= 'Informaci&oacute;n sobre herramientas';
$lang['op_seconds']							= 'segundos';
$lang['op_max_fleets_messages']				= 'M&aacute;ximo mensajes de flotas';
...
$lang['op_dlte_account_descrip']			= 'Seleccionando esta opciones borrar&aacute;s tu cuenta dentro de 7 d&iacute;as';
$lang['op_sort_colonization']				= 'Fecha de colonizaci&oacute;n';
$lang['op_sort_coords']						= 'Coordenadas';
$lang['op_sort_alpha']						= 'Orden alfab&eacute;tico';
...
$lang['sys_moonbuilt'] 						= "Las enormes cantidad de metal y cristal se fucionan y forman un sat&eacute;lite lunar en la orbita del planeta %s [%d:%d:%d] !";
...
$lang['damage']								= "puntos de da&ntilde;o.";
...
$lang['sys_mess_spy_lostproba'] 			= "Probabilidad de detecci&oacute;n de la flota de espionaje : %d %% ";
...
$lang['sys_colo_mess_from'] 				= "Colonizaci&oacute;n";
...
$lang['sys_colo_maxcolo'] 					= ", pero, por desgracia, es imposible colonizar, no puede tener m&aacute;s ";
$lang['sys_colo_allisok'] 					= ", 	los colonos est&aacute;n comenzando a construir una nueva colonia.";
$lang['sys_colo_badpos']  					= ", 	los colonos han encontrado un entorno propicio para la extensi&oacute;n de su imperio. Decidieron dar marcha atr&aacute;s totalmente asqueado...";
$lang['sys_colo_notfree'] 					= ", 	los colonos no han encontrado un planeta con estos detalles. Ellos se ven obligados a dar marcha atr&aacute;s completamente desmoralizados...";
...
$lang['sys_expe_nothing_2'] 				= "Tus exploradores han pasado todo el tiempo en el &aacute;rea seleccionada. Pero no han encontrado nada.";
...
$lang['sys_expe_back_home'] 				= "Tu expedici&oacute;n regres&oacute; al hangar.";
$lang['sys_mess_transport'] 				= "Flota de Transporte";
$lang['sys_tran_mess_owner'] 				= "Una de tus flota llega a %s %s y entrega su mercanc&iacute;a: %s de %s, %s de %s y %s de %s.";
$lang['sys_tran_mess_user']  				= "Una flota proveniente de %s %s llega a tu planeta y entrega su mercanc&iacute;a: %s de %s, %s de %s y %s de %s.";
...
$lang['sys_notenough_money'] 				= "No tienes suficientes recursos para contruir una % s. Tienes %s de %s, %s de %s y %s de %s y el costo de la construcci&oacute;n era %s de %s, %s de %s y %s de %s";
...
$lang['sys_destruc_stop'] 					= "El defensor ha conseguido detener la destrucci&oacute;n de la luna";
...
$lang['sys_stay_mess_bend']        			= " y entrega su mercanc&iacute;a ";

//----------------------------------------------------------------------------//
//class.CheckSession.php
$lang['ccs_multiple_users']					= '&iexcl;Error de cookies! &iexcl;Hay varios usuarios con este nombre! Debe eliminar sus cookies. En caso de problemas contacte al administrador.';
$lang['ccs_other_user']						= '&iexcl;Error de cookies! &iexcl;Su cookie no corresponde con el usuario! Debe eliminar sus cookies. En caso de problemas contacte al administrador.';
$lang['css_different_password']				= '&iexcl;Error de cookies! &iexcl;Error de sesi&oacute;n, debe conectarse de nuevo! Debe eliminar sus cookies. En caso de problemas contacte al administrador.';
...
$lang['cff_the_position']					= 'la posici&oacute;n ';
...
$lang['cff_from_position']					= 'de la posici&oacute;n ';
...
$lang['cff_with_the_mission_of']			= '. Con la misi&oacute;n de: ';
...
//----------------------------------------------------------------------------//
// CombatReport.php
$lang['cr_lost_contact']					= 'Se perdi&oacute; el contacto con la flota atacante.';
...
$lang['cr_destroyed']						= '&iexcl;Destruida!';
...
$lang['fa_mission_not_available']			= 'Error, la misi&oacute;n no esta disponible';
$lang['fa_no_ships']						= 'Error, no hay naves disponibles';
$lang['fa_vacation_mode']					= 'Error, el jugador se encuentra en modo vacaciones';
$lang['fa_week_player']						= 'Error, el jugador es demasiado debil';
...
$lang['ma_missile']							= ' misiles, s&oacute;lo dispones de ';
$lang['ma_wrong_target']					= 'Objetivo Incorrecto';
$lang['ma_no_missiles']						= 'No hay misiles interplanetarios disponibles';
$lang['ma_add_missile_number']				= 'Ingresar el n&uacute;mero de misiles que deseas enviar';
$lang['ma_misil_launcher']					= 'Lanzamisiles';
$lang['ma_small_laser']						= 'L&aacute;ser peque&ntilde;o';
$lang['ma_big_laser']						= 'L&aacute;ser grande';
$lang['ma_gauss_canyon']					= 'Ca&ntilde;&oacute;n Gauss';
$lang['ma_ionic_canyon']					= 'Ca&ntilde;&oacute;n i&oacute;nico';
$lang['ma_buster_canyon']					= 'Ca&ntilde;&oacute;n de plasma';
$lang['ma_small_protection_shield']			= 'C&uacute;pula peque&ntilde;a de protecci&oacute;n';
$lang['ma_big_protection_shield']			= 'C&uacute;pula grande de protecci&oacute;n';
$lang['ma_all']								= 'Todo';
$lang['ma_missiles_sended']					= ' misiles interplanetarios se enviaron. objetivo principal: ';
$lang["ma_all_destroyed"]  					='Todos los misiles interplanetarios han sido destruidos por los misiles de intercepci&oacute;n.';
$lang['ma_planet_without_defens']  			='Planeta sin defensa.';
$lang['ma_some_destroyed']   				=' han sido destruidos por los misiles de intercepci&oacute;n.';
