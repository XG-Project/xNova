...
$lang['lost_pass_text'] 				= 'Para recuperar tu contraseña, introduce el email utilizado en el registro. Recibirás una nueva clave a la brevedad.';
...
$lang['server_description']				= '</strong> es un <strong>juego de simulacion estratégica espacial</strong> con <strong>muchos jugadores</strong> a lo largo del mundo compitiendo por ser el mejor <strong>simultáneamente</strong>. Todo lo que necesitas para jugar, es un navegador web.';
$lang['server_register']				= '¡Regístrate!';
...
$lang['welcome_message_content']		= '¡Bienvenido a xNova!<p>Al comenzar, construye una mina de Metal.<br>Para hacerlo, haz clic en el enlace "Edificios" en la izquierda, y dale a "construir" a la derecha de la mina de metal.<br>Ahora tienes algo de tiempo para conocer más cosas del juego.<p>Podrás encontrar ayuda:<br>En el <a href="http://www.razican.com/" target="_blank">Foro</a><br>Ahora, tu mina debería estar acabada.<br>Como no producen nada sin energía, deberías construir una Planta de energía solar, vuelve a Edificios, y elige construir la Planta de energía solar.<p>Para ver todas las naves, estructuras defensivas, edificios e investigaciones que puedes investigar, puedes echarle un vistazo al árbol de tecnología en "Tecnología" en el menú izquierdo.<p>Ahora ya puedes empezar la conquista del universo... ¡Buena suerte!';
...
$lang['accept_terms_and_conditions']	= 'Aceptar términos y condiciones de uso';
