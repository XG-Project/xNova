...
$lang['server_description']			= '</strong> es un <strong>juego de simulacion estratégica espacial</strong> con <strong>muchos jugadores</strong> a lo largo del mundo compitiendo por ser el mejor <strong>simultáneamente</strong>. Todo lo que necesitas para jugar, es un navegador web estándar.';
